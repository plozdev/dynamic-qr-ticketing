...
/**
 * Remote data source interface for ticket queries and claiming.
 */
interface ITicketRemoteDataSource {
    ...
    suspend fun claimTicket(eventId: String, categoryName: String? = null, attendeeName: String? = null): NetworkResult<TicketDto>

    suspend fun fetchEvents(): NetworkResult<List<EventItemDto>>
}
